...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/10/2020"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("Tenha um bom dia!", sdf.parse("23/03/2020"), new AuthorDTO(alex));
